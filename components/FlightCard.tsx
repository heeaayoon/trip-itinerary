...
export default function FlightCard({ item }: Props) {
  ...
  return (
    <div className={`rounded-2xl border-2 p-4 shadow-sm transition-all ${style.card.border} bg-linear-to-br from-sky-50 to-indigo-50`}>
      <div className="flex items-center gap-3 mb-3">
        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${style.card.bg} ${style.text}`}>
